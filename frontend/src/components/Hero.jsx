...
const Hero = () => {
  return (
    ...
    dark:text-white'>
        ...
        max-w-4/5 sm:max-w-lg pb-3'>Creating menaingful connections and turning big ideas into interactive 
            digital experiences.
        </p>
